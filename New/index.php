...
<body>
    ...
    <section class="about text-center" id="about">
        <div class="container">
            <div class="row">
                <h2>Electronic Health Record Managment</h2>
                <h4>Caring For You..</h4>
                <div class="col-md-4 col-sm-6">
                    <div class="single-about-detail clearfix">
                        <div class="about-img">
                            <img class="img-responsive" src="imgs/item1.jpg" alt="">
                        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-about-detail">
                        <div class="about-img">
                            <img class="img-responsive" src="imgs/item2.jpg" alt="">
                        </div>
                        <div class="about-details">
                            <div class="pentagon-text">
                                <h1>*</h1>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-about-detail">
                        <div class="about-img">
                            <img class="img-responsive" src="imgs/item3.jpg" alt="">
                        </div>
                        <div class="about-details">
                            <div class="pentagon-text">
                                <h1>*</h1>
            ...
            <div class="row">
                    ...
                    <div class="single-service">
                        <div class="single-service-img">
                            <div class="service-img">
                                <img class="heart img-responsive" src="imgs/service1.png" alt="">
                            </div>
                        </div>
                        <h3>sample text</h3>
                    </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-service">
                        <div class="single-service-img">
                            <div class="service-img">
                                <img class="brain img-responsive" src="imgs/service2.png" alt="">
                            </div>
                        </div>
                        <h3>sample text</h3>
                    </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-service">
                        <div class="single-service-img">
                            <div class="service-img">
                                <img class="knee img-responsive" src="imgs/service3.png" alt="">
                            </div>
                        </div>
                        <h3>sample text</h3>
                    </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-service">
                        <div class="single-service-img">
                            <div class="service-img">
                                <img class="bone img-responsive" src="imgs/service4.png" alt="">
                            </div>
                        </div>
                        <h3>sample text</h3>
                    </div>
